...
while(true)//infinite time input nite cai ajnno infinite loop calaisi
{
    ...
    cout<<"Option 2:print linked list"<<endl;//done
     cout<<"Option 3:insert at any position"<<endl;//error handle korte hobe->done
         cout<<"Option 4:Insert at head "<<endl;//done
         cout<<"Option 5: delete from position"<<endl;//ulta palta position dile jhamela hobe->done
          cout<<"Option 6:delete head "<<endl;//head na thakle error khabe
